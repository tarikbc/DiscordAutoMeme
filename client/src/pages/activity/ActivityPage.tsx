  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        showNotification('error', 'Error Loading Activity', 'Failed to load activity data. Please try again.');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="mt-3 sm:mt-0 sm:ml-4 flex flex-wrap gap-2">
          ...
          <div className="flex rounded-md shadow-sm">
            <button
              ...
              className={`relative inline-flex items-center rounded-l-md px-3 py-2 text-sm font-semibold ${timeRange === '24h'
            ...
            <button
              ...
              className={`relative -ml-px inline-flex items-center px-3 py-2 text-sm font-semibold ${timeRange === '7d'
                ? 'bg-blue-600 text-white hover:bg-blue-700'
                : 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600'
                } focus:z-10 focus:outline-none`}
            >
            ...
            <button
              ...
              className={`relative -ml-px inline-flex items-center rounded-r-md px-3 py-2 text-sm font-semibold ${timeRange === '30d'
                ? 'bg-blue-600 text-white hover:bg-blue-700'
                : 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600'
                } focus:z-10 focus:outline-none`}
            >
      ...
      <div className="mt-6">
        {loading ? (
                    ...
                    <div className="relative flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0 bg-white dark:bg-gray-800 shadow sm:rounded-lg p-4">
                        <div>
                          ...
                          {activity.details && (
                            <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">{activity.details}</p>
                          )}
                        </div>
                      </div>
                    </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900 dark:text-white">No activity found</h3>
